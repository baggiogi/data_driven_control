function [u_opt,norm_u,err] = data_driven_min_energy_approx(U,Y,sys,T,yf)
% DATA_DRIVEN_MIN_ENRGY - computes approximate data-driven minimum-energy control
%
% Syntax:  [u_opt,norm_u,err] = data_driven_min_energy_approx(U,Y,T,yf)
%
% Inputs:
%    U - input data matrix
